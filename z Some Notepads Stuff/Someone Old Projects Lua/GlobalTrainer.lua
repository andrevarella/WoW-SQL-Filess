...
if (intid == 2) then -- Paladin
        ...
        player:LearnSpell(34769) --Mounts 
        player:LearnSpell(34767) --Mounts
		player:LearnSpell(196)
		player:LearnSpell(197)
		player:LearnSpell(198)
		player:LearnSpell(199)
...
if (intid == 5) then -- Priest
        player:LearnSpell(719930) --Boost Spell damage %
        player:LearnSpell(14799) --Boost Spell damage
...
if (intid == 8) then -- Mage
		...
		player:LearnSpell(719930) --Boost Spell damage %
		player:LearnSpell(14799) --Spell Boost Damage
