...
- Audit performance
-- Investigate rage/energy/mana checks for "usable"
...
-Added Buff equivalencies for groups of spells with similar effects. Use the following groups (capitalization matters):
  -Bleeding
  -VulnerableToBleed
  -Incapacitated
