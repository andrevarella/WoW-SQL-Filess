...
ActionBarUpButton:SetPoint("CENTER", MainMenuBar, "BOTTOMLEFT", 521, 30.2)
ActionBarDownButton:SetPoint("CENTER", MainMenuBar, "BOTTOMLEFT", 521, 11.1)
MainMenuBarPageNumber:SetPoint("CENTER", MainMenuBar, "BOTTOMLEFT", 541, 21)
