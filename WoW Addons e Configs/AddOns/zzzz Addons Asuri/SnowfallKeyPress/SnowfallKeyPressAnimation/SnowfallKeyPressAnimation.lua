...
local animationsCount = 2; -- default 5
local animations = {};
...
for i = 1, animationsCount do
  ...
  texture:SetVertexColor(0.5, 0.5, 0.5, 0); -- default 1, 1, 1, 0
  texture:SetAlpha(0);
  ...
  rotation2:SetDuration(0.3); -- default 0.2
