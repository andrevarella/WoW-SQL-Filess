...
r=m[c];if(not I(r)or r:GetAttribute("","downbutton",l))then
return;end
h=SecureButton_GetModifiedAttribute(r,"harmbutton",l);O=SecureButton_GetModifiedAttribute(r,"helpbutton",l);B=SecureButton_GetModifiedAttribute(r,"type",l);S=SecureButton_GetModifiedAttribute(r,"type",h);u=SecureButton_GetModifiedAttribute(r,"type",O);if(B and not T[B]or S and not T[S]or u and not T[u])then
return;end
else
l="LeftButton";end
...
return;end
d=false;if(not SnowfallKeyPressSV.enable)then
...
f(e.button);end
return;end
local t=T(o,e)or{owner=o};t.command=r;t.override=nil;if(a[n]and SnowfallKeyPressSV.enable)then
...
SnowfallKeyPressSV={keys={},animation=false,enable=true};end
...
h();end
i();InterfaceOptions_AddCategory(e);o:UnregisterAllEvents();o:SetScript("OnEvent",l);o:RegisterEvent("UPDATE_BINDINGS");end
