...
L:AddLocale("koKR",  
{
	...
	-- ["Set Position"] = "",
	-- ["Set Strata"] = "",
	["Set the alpha of the editbox."] = "입력창의 투명도를 설정합니다.", -- Needs review
	-- ["Set the amount of padding inside the edit box"] = "",
	["Set the edit box background colour"] = "입력창의 배경색을 설정합니다.", -- Needs review
	["Set the edit box border colour"] = "입력창의 가장자리 색을 설정합니다.", -- Needs review
	["Set the frame strata of the editbox."] = "입력창의 프레임 레벨을 설정합니다.", -- Needs review
	["Set the position of the editbox."] = "입력창의 위치를 설정합니다.", -- Needs review
	["Set the texture of the chat edit box"] = "대화 입력창의 질감을 설정합니다.", -- Needs review
	-- ["Set the width of the editbox."] = "",
	-- ["Set the width of the edit box's border"] = "",
	["Set Width (NB: only enabled if the editbox is undocked)"] = "폭 설정(주의: 입력창이 고정되있지 않아야 가능합니다.)", -- Needs review
	Texture = "무늬",
	Top = "위",
	Undocked = "고정안함",
}
...
L:AddLocale("ruRU",  
{
	...
	-- BACKGROUND = "",
	["Bar colour"] = "Цвет панели", -- Needs review
	["Border colour"] = "Цвет границ",
	["Border width"] = "Ширина границ",
	Bottom = "Внизу",
	Clickable = "Щелчки мыши", -- Needs review
	...
	["Set Width (NB: only enabled if the editbox is undocked)"] = "Уст. ширину (Пометка: включен только если поле ввода разблокировано)", -- Needs review
	Texture = "Текстура",
	Top = "Верх",
	Undocked = "Отстыкован",
}
