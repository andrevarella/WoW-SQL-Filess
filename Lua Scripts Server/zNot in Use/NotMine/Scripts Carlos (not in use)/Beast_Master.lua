local UnitEntry = 26307

local function BeastMaster_T(unit, player, creature)
    player:GossipSetText(string.format("                     |TInterface\\icons\\Ability_druid_healinginstincts:55:55:30:0|t\n\nO menu de |cffff0000Pets Exóticos|cFF000000, só aparecerá se o jogador for |cffff0000Beast Mastery|cFF000000.\n\nOs pets são dividos em 3 famílias e 4 tipos de especializações, sendo uma exclusiva para |cffff0000Beast Mastery|cFF000000."))
    if  player:GetClass() == 3 then    
	    player:GossipMenuAddItem(3,"|TInterface\\icons\\Ability_hunter_pet_wolf:25|t Pets",0, 1)
        player:GossipMenuAddItem(3,"|TInterface\\icons\\inv_box_petcarrier_01:25|t Pet Stable",0, 2)
        player:GossipMenuAddItem(3,"|TInterface\\icons\\Ability_hunter_beasttraining:25|t Pet Food",0, 3)
        player:GossipMenuAddItem(3,"|TInterface\\icons\\Ability_marksmanship:25|t Reset Pet Talent Points",0, 4)
...
if (intid == 1) then
        player:GossipSetText(string.format("                     |TInterface\\icons\\Ability_druid_healinginstincts:55:55:30:0|t\n\nO menu de |cffff0000Pets Exóticos|cFF000000, só aparecerá se o jogador for |cffff0000Beast Mastery|cFF000000.\n\nOs pets são dividos em 3 famílias e 4 tipos de especializações, sendo uma exclusiva para |cffff0000Beast Mastery|cFF000000.\n\nPets normais, custam de |cffff00002 |cff0000ffDias Vip|cFF000000, pets exóticos, |cffff00004 |cff0000ffDias Vip|cFF000000."))
...
if(intid == 3) then
   player:SendListInventory(creature, 3322)
end
