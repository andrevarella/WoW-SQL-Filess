...
player:GossipSetText(string.format("Utilize esse |cff0000ffNPC|cFF000000 para teleportar para o Mall e outros lugares."))
    ...
    player:GossipMenuAddItem(4,"|TInterface\\icons\\Achievement_zone_nagrand_01.png:29|t Nagrand - |cFFFFFF00Duel Zone 1 ",0, 4, false, "Tem certeza que quer teleportar para Nagrand")
    player:GossipMenuAddItem(4,"|TInterface\\icons\\Achievement_zone_tanaris_01:29|t Tanaris - |cFFFFFF00Duel Zone 2 ",0, 3, false, "Tem certeza que quer teleportar para Tanaris?")
