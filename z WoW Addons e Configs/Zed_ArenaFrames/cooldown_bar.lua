...
local MAX_ICONS = 10
local PVP_TRINKET_TEXTURE = "Interface\\Icons\\spell_holy_dispelmagic"
...
["Warrior"] = {
				...
				{ name = "Bladestorm", icon = select(3,GetSpellInfo(46924)) },
},
["Death Knight"] = {
				{ name = "PvP Trinket", icon = PVP_TRINKET_TEXTURE },
				{ name = "Anti-Magic Shell", icon = select(3,GetSpellInfo(48707)) },
				{ name = "Death Grip", icon = select(3,GetSpellInfo(49576)) },
},
["Rogue"] = {
				{ name = "PvP Trinket", icon = PVP_TRINKET_TEXTURE },
				{ name = "Cloak of Shadows", icon = select(3,GetSpellInfo(31224)) },
				{ name = "Kidney Shot", icon = select(3,GetSpellInfo(8643)) },
				{ name = "Shadowstep", icon = select(3,GetSpellInfo(36554)) },
				{ name = "Shadowdance", icon = select(3,GetSpellInfo(51713)) },
},
["Hunter"] = {
				{ name = "PvP Trinket", icon = PVP_TRINKET_TEXTURE },
				{ name = "Scatter Shot", icon = select(3,GetSpellInfo(19503)) },
				{ name = "Freezing Arrow", icon = select(3,GetSpellInfo(60192)) },
				{ name = "Freezing Trap", icon = select(3,GetSpellInfo(14311)) },
				
},
["Shaman"] = {
				{ name = "PvP Trinket", icon = PVP_TRINKET_TEXTURE },
				{ name = "Hex", icon = select(3,GetSpellInfo(51514)) },
...
["Paladin"] = {
				...
				{ name = "Divine Shield", icon = select(3,GetSpellInfo(642)) },
},
["Warlock"] = {
				{ name = "PvP Trinket", icon = PVP_TRINKET_TEXTURE },
				{ name = "Howl of Terror", icon = select(3,GetSpellInfo(17928)) },
				{ name = "Demonic Circle: Teleport", icon = select(3,GetSpellInfo(48020)) },
